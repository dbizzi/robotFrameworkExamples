...
${HOME_BTN_ADD_CART}     xpath=//*[@id="add_to_cart"]/button
${HOME_BTN_CHECKOUT}     xpath=//*[@id="layer_cart"]//a[@title="Proceed to checkout"]
${SIGNIN_BTN}            xpath=//*[@id="header"]//*[@class="login"][contains(text(),"Sign in")]
...
Clicar no botão "Add to Cart" do produto
    ...
    Wait Until Element Is Visible   ${HOME_BTN_ADD_CART}
    Click Button                    ${HOME_BTN_ADD_CART}
